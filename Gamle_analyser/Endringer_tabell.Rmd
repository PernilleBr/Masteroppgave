...
Resultatskjema <- read_excel("Gjeldende analyser/Resultatskjema.xlsx", na = "NA")
Resultatskjema.ITT <- read_excel("Gjeldende analyser/Resultatskjema_ITT.xlsx", na = "NA")
Analyser.pvalue <- read_excel("Gjeldende analyser/Analyser_p.verdi.xlsx")
view(Analyser.pvalue)
