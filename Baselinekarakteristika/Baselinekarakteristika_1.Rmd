...
table2 <- Resultatskjema %>%
  ...
  select(id, group, time, sex, age, height, weight, bmi, fat_mass, lean_mass, sys, dia, wc, vat_mass, handgrip, vo2max_ml_min_kg_6x5, `1rm_newton`) %>%
  ...
  mutate(variable = factor(variable, levels = c("n", "age", "height", "weight", "bmi", "fat_mass_kg", "lean_mass_kg", "sys", "dia", "wc", "vat_mass", "vo2max_ml_min_kg_6x5", "handgrip", "1rm_newton"),
