...
table2 <- Resultatskjema %>%
  ...
  select(id, group, time, sex, age, height, weight, bmi, fat_mass, lean_mass, sys, dia, vat_mass, wc, `s-triglyserider`, `s-hdl`, `s-ldl`, `s-glukose`, pwv, handgrip, vo2max_ml_min_kg_6x5, `1rm_newton`, phys_act_min) %>%
  ...
  mutate(variable = factor(variable, levels = c("n", "age", "height", "weight", "bmi", "fat_mass_kg", "lean_mass_kg", "sys", "dia", "vat_mass", "wc", "s-triglyserider", "s-hdl", "s-ldl", "s-glukose", "pwv", "vo2max_ml_min_kg_6x5", "handgrip", "1rm_newton", "phys_act_min"),
                           labels = c("n", "Alder (år)", "Høyde (cm)", "Vekt (kg)", "BMI (kg/m2)", "Fettmasse (kg)", "Mager masse (kg)", "Systolisk blodtrykk (mmHg)", "Diastolisk blodtrykk (mmHg)", "Visceralt fett (g)", "Midjeomkrets (cm)", "Triglyserider (mmol/l)", "HDL-kolesterol (mmol/l)", "LDL-kolesterol (mmol/l)", "Glukose (mmol/l)", "Pulsbølgehastighet (m/s)", "VO2maks (ml/min/kg)", "Gripestyrke (kg)", "Benstyrke 1RM (kg)", "Aktivitetsnivå (min/uke)"))) %>%
