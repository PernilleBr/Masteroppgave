...
figur.vat.pp <- mean.pp.vat %>%
  ggplot(aes(group, mean.vat.pp, group = group)) + geom_boxplot(width = 0.3, fill = "white", colour = "black") + geom_errorbar(aes(ymin = mean.vat.pp - sd.vat.pp, ymax = mean.vat.pp + sd.vat.pp), width = 0.1) + theme_classic() + geom_point(data = pp.vat, aes(group, change.vat.pp), size = 2, alpha = 0.4) + labs(x = "Gruppe", y = "Endring i visceralt fett (g)") + geom_hline(yintercept = 0, linetype = "solid", color = "black") + theme(axis.title = element_text(size = 11), axis.text.x = element_text(size = 10), axis.text.y = element_text(size = 10)) + ylim(-400, 400)
...
figur.vat.ppm <- mean.ppm.vat %>%
  ggplot(aes(group, mean.vat.ppm, group = group)) + geom_boxplot(width = 0.3, fill = "white", colour = "black") + geom_errorbar(aes(ymin = mean.vat.ppm - sd.vat.ppm, ymax = mean.vat.ppm + sd.vat.ppm), width = 0.1) + theme_classic() + geom_point(data = ppm.vat, aes(group, change.vat.ppm), size = 2, alpha = 0.4) + labs(x = "Gruppe", y = "Endring i visceralt fett (g)") + geom_hline(yintercept = 0, linetype = "solid", color = "black") + theme(axis.title = element_text(size = 11), axis.text.x = element_text(size = 10), axis.text.y = element_text(size = 10)) + ylim(-400, 400)
